...
namespace GesInv.Controllers
{
    public class CategoriumsController : Controller
    {
        ...
        public CategoriumsController(GestionInvContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CategoriaId,Nombre,Descripcion")] Categorium categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaId,Nombre,Descripcion")] Categorium categorium)
        {
